...
NARVAL to pierwszy programowy agent dostępny jako Wolne
Oprogramowanie.

Narval to skrót od "Network Assistant Reasoning with a Validating
Agent Language".

Narval to szkielet (język + interpreter + GUI/IDE) dedykowany
tworzeniu inteligentnych osobistych asystentów. Inteligentny osobisty
asystent to towarzysz, który pomoże ci w codziennej pracy w świecie
informacji.
